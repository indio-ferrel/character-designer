...
bottomDropdown.addEventListener('change', () => {
    ...
    bottomEl.style.backgroundImage = `url("./assets/${botValue}-pants.png")`;
    // update the stats to show the new count (call displayStats() to do this work)
    displayStats();
});
...
catchphraseButton.addEventListener('click', () => {
    ...
    let newCatchphrase = catchphraseInput.value;
...
function displayStats() {
    ...
    reportEl.textContent = `You have changed the head ${headCount} times, the torso ${middleCount} times, and the legs the head ${bottomCount} times.`;
}
...
function displayCatchphrases() {
    ...
    const catchphraseList = document.getElementById('catchphrases');
    // clear out the existing catchphrases
    
    for (let phrase of catchphrases) {
        // create an element with the catchphrase at textContent
